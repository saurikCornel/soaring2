...
struct CardOptionStyle: Identifiable {
    let id: String
    let buyImage: String
...
struct StyleView: View {
    ...
    private let cardOptions: [CardOptionStyle] = [
        CardOptionStyle(id: "firstCard", buyImage: "firstCardBuy", selectImage: "firstCardSelect", closeImage: "background1", selectedImage: "firstCardSelected"),
        CardOptionStyle(id: "rockCard", buyImage: "rockBuy", selectImage: "rockSelect", closeImage: "background2", selectedImage: "rockSelected"),
        CardOptionStyle(id: "seaCard", buyImage: "seaBuy", selectImage: "seaSelect", closeImage: "background3", selectedImage: "seaSelected")
    ]
    ...
    private func currentImage(for card: CardOptionStyle) -> String {
    ...
    private func handleCardAction(for card: CardOptionStyle) {
